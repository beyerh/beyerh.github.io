...
We will transform and induce protein production in the *Escherichia coli* strain T7-Express using competent cells following the scheme in **Figure cloning-strategy**:
...
![Figure 1](/img/user/figures/inteins_boolean_gates.png)
