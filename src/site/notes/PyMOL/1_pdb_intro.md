...
```bash
# 1. Create a new environment named 'pymol'
conda create -n pymol

# 2. Activate the environment and install software
conda activate pymol
conda install conda-forge::pymol-open-source

# 1.1 for movie support, install also ffmpeg
...
Your best friend: https://pymolwiki.org/
