...
1.  A **t**etracycline-controlled **t**rans**a**ctivator (tTA) or rtTA-reverse rTA), which binds to tetracycline response elements (TRE) or the tet operator *tetO*, located upstream of the gene of interest.
...
[← Previous](garden_06-Experiment4.md) \| [Next →](garden_08-References.md)
