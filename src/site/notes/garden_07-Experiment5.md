...
**Table 23.** Materials for Experiment V.
...
**Table 24.** Used plasmids prepared by the supervisors.

| Name   | Description                                         | Concentration |
|--------|-----------------------------------------------------|---------------|
| pDD312 | P<sub>CAG-</sub>TetOn3G-Tbg - Ptre3gv-mneonGreen-pA | 1926 ng/µL    |
| pME001 | P<sub>CMV</sub>-PB transposase-pA                   | 2126 ng/µL    |
...
![Figure 20. Stable transfection calculation sheet.](/img/user/figures/stable_transfection.png)

**Figure 20.** Stable transfection calculation sheet.
