...
![Figure 18. Domain swapping at the plasma membrane. Split intein-catalyzed protein trans-splicing (PTS) reaction either leading to the addition (left), or exchange (right) of GFP and mCherry at the plasma membrane, depending on the domain order of the GFP constructs (pDD130 vs pDD132). The IntC-fused mCherry construct pDD131 is identical in both approaches.](/img/user/figures/inteins_plasms_membrane.png)

**Figure 18.** **Domain swapping at the plasma membrane.** Split intein-catalyzed protein trans-splicing (PTS) reaction either leading to the addition (left), or exchange (right) of GFP and mCherry at the plasma membrane, depending on the domain order of the GFP constructs (pDD130 vs pDD132). The Int<sub>C</sub>-fused mCherry construct pDD131 is identical in both approaches.
...
**Table 15.** Plasmid DNA (Minipreps)

| Name   | Description                                    | Concentration |
|--------|------------------------------------------------|---------------|
| pDD130 | P<sub>SV40</sub>-LckM/P-GFP-Int<sub>N</sub>-pA | 100 ng/µL     |
| pDD131 | P<sub>SV40</sub>-Int<sub>C</sub>-mCherry-pA    | 100 ng/µL     |
| pDD132 | P<sub>SV40</sub>-LckM/P-Int<sub>N</sub>-GFP-pA | 100 ng/µL     |
...
| Opti-MEM<sup>TM</sup> | Optimized minimum essential medium (Gibco), serum-free.                                                                                   |
| Lysogeny broth (LB)   | 10 g/L tryptone, 5 g/L yeast extract, 10 g/L NaCl, pH 7.0.                                                                                |
| LB-agar plates (Amp)  | 20 g/L Bacto Agar in 500 mL dH<sub>2</sub>O, 100 µg/mL Ampicillin.                                                                        |
...
**Table 18.** Buffers and chemicals
...
| NEU/P3                  | 3.0 M potassium acetate, dH<sub>2</sub>O to 1 L                                                 |
| EQU                     | 750 mM NaCl, 50 mM MOPS, 15% isopropanol, 0,15% Triton X-100, dH<sub>2</sub>O to 1 L            |
| WASH                    | 1.0M NaCl, 50 mM MOPS, 15% isopropanol, dH<sub>2</sub>O to 1 L                                  |
| ELU                     | 1.25M NaCl, 50 mM Tris-Cl, 15% isopropanol, dH<sub>2</sub>O to 1 L                              |
| 2-Propanol              | (Sigma)                                                                                         |
| 70% Ethanol             | 70 ml Ethanol absolute (Chemsolute), dH<sub>2</sub>O to 100 mL                                  |
| H<sub>2</sub>O          |                                                                                                 |
| Polyethyleneimine (PEI) | 1 mg/mL PEI (25 kDa) in dH<sub>2</sub>O, pH 7 (HCl), sterile filtered with 0.2 μM pore size     |
| Mowiol (Roth)           | 6 g glycerol, 2.4 g Mowiol 4-88, 6 mL dH<sub>2</sub>O, 12 mL 0.2 M Tris-HCl pH 8.5              |
...
19. Resuspend with 70–120 µL ddH<sub>2</sub>O (sterile).
...
This step should be performed only by one member of each group to prevent overcrowding in the cell culture room. Together with the supervisors, you will prepare a shared cell suspension. Each present group member will then seed the required number of cells in a 24-well plate (one plate per group)
...
**Table 20.** Well plate layout: Seed wells 1, 2, and 3 in a 24-well plate (6 wells per group).
...
1.  Per well, dilute 0.75 µg of DNA in OptiMEM to a final volume of 50 µL (remember your Midi-prep concentration). Please check **[Table 21](#tbl:transfection-odd)** and **[Table 22](#tbl:transfection-even)** for further information.
...
3.  Per well, dilute 2.5 µL of PEI solution in OptiMEM to a final volume of 50 µL. Vortex. Please check **[Table 21](#tbl:transfection-odd)** and **[Table 22](#tbl:transfection-even)** for further information.
