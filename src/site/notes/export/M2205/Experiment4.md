---
{"dg-publish":true,"permalink":"/export/m2205/experiment4/","title":"Experiment 4"}
---
...
<figure id="tbl:materials-exp-III" class="align-left" style="width: 100%; float: left; margin-right: 1em">
  <figcaption>
...
<td style="text-align: left;">10 g/L tryptone, 5g/L yeast extract, 10
g/L NaCl, pH 7.0.</td>
...
1.  Per well, dilute 0.75 µg of DNA in OptiMEM to a final volume of 50 µL (remember your Midi-prep concentration). Please check **Table 7** and **Table 8** for further information.
...
3.  Per well, dilute 2.5 µL of PEI solution in OptiMEM to a final volume of 50 µL. Vortex. Please check **Table 7** and **Table 8** for further information.
...
\[\[Experiment3\|← Previous\]\] \| \[\[Experiment5\|Next →\]\]
