---
{"dg-publish":true,"permalink":"/export/m2205/index/","title":"Current Methods in Synthetic Biology for Biomedical Research","tags":["gardenEntry"]}
---
...
> [!figure] #fig:schedule-part1 width=100% align=left pos=H
> <iframe src="/img/user/figures/schedule_part1.pdf" width="100%" height="900px" title="schedule_part1" style="border:1px solid #ccc;"></iframe>
>
> Time Schedule for the first two weeks of the course.


> [!figure] #fig:schedule-part2 width=100% align=left pos=H
> <iframe src="/img/user/figures/schedule_part2.pdf" width="100%" height="900px" title="schedule_part2" style="border:1px solid #ccc;"></iframe>
>
...
> [!table] #tbl:cell-lines width=100% align=left columns=0.2,0.4,0.4
> 
...
**A. Restriction and ligation cloning.** This technique relies on the presence of restriction enzyme (dE) recognition sites flanking the desired insert and at the desired positions in the recipient plasmid. The REs will then generate double DNA cuts leaving cohesive or blunt ends in both DNA sequences, in two independent reactions. Afterwards, we will purify the digested fragments and ligate them together using an enzyme called T4 DNA ligase, before transformation into chemically competent *E. coli* TOP10 bacteria for subsequent amplification and selection. T4 DNA ligase will conduct the repair of the broken DNA by forming a phosphodiester bond between a nearby 5’‑phosphate and 3’-OH ends resulting in the assembly of the desired new vector (**@Fig:cloning-strategy**).

**B. Advanced Quick Assembly (AQUA) Cloning.** In contrast to conventional restriction/ligation cloning, this technique allows us to design a vector independently of the presence of suitable RE sites or the use of DNA restriction enzymes and ligases. This versatile and inexpensive technique relies on *in-vivo* DNA recombination within *E. coli* and therefore, requires DNA fragments that share an overlapping region of 20-60 bp at the junction sites. The homology region can for example be generated by PCR using appropriate primers that add these sequences to the products (**@Fig:cloning-strategy**). AQUA Cloning can also be used to clone multiple DNA fragments simultaneously, reminiscent to other “DNA assembly cloning” methods. Additionally, a combination of restriction of the backbone and PCR amplification of the insert (as we will see in our exercise) can be used.
...
> [!figure] #fig:cloning-strategy width=100% align=left pos=H
> <iframe src="/img/user/figures/cloning_strategies.pdf" width="100%" height="900px" title="cloning_strategies" style="border:1px solid #ccc;"></iframe>
>
> **Illustration of the cloning strategy.** Top, schematic representation of the cloned vectors. Bottom, pRSFDuet-1 plasmid (KanR) digested with *Bam*HI and *Kpn*I serves as backbone for cloning plasmids pDD259/262 and 260. The inserts for these constructs are the amplification products of pDD002 and pDD083 with the primers oDD561 and oDD562; or the PCR product of pDD002 with oDD561 and oDD563, respectively.
...
> [!table] #tbl:materials-exp1 width=\textwidth fontsize=small family=sffamily colsep=3pt spacing=1.0 columns=0.16,0.18,0.42,0.08,0.16 align=left
> 
...
|                             | oDD564                                 | To be determined in the exercise.                                                          | 25 µM         | NpuE\_C F *Nde*I bad          |
...
> [!table] #tbl:pcr-mixture width=100% align=left
> 
...
| Primer 2, 25 µM        | 1      | µL     |
| dNTPs, 10 mM           | 1      | µL     |
| Template DNA (~ 10 ng) | 1      | µL     |
| Q5 DNA polymerase      | 0.5    | µL     |
| add dH$_2$O            | 32.5   | µL     |
| **Total**              | **50** | **µL** |

> [!table] #tbl:primers-templates width=100% align=left
> 
...
> [!table] #tbl:pcrprogram width=100% align=left colsep=4pt fontsize=footnotesize spacing=1.1
>
> PCR program
...
> [!figure] #fig:dna-ladder width=40% align=left pos=H
> ![](/img/user/figures/dna_ladder.png)
...
> [!table] #tbl:digest_bb width=100% align=left columns=0.25,0.45,0.30 colsep=4pt fontsize=footnotesize spacing=1.1
>
...
> [!table] #tbl:pcr_digest width=100% align=left columns=0.25,0.45,0.30 colsep=4pt fontsize=footnotesize spacing=1.1
>
...
> [!table] #tbl:digest width=100% align=left columns=0.25,0.45,0.30 colsep=4pt fontsize=footnotesize spacing=1.1
>
...
> [!table] #tbl:ligation width=100% align=left columns=0.25,0.45,0.30 colsep=4pt fontsize=footnotesize spacing=1.1
>
> DNA ligation
...
##### 4.1 Plasmid DNA Isolation (4 samples)
...
> [!table] #tbl:testdigest width=100% align=left columns=0.25,0.45,0.30 colsep=4pt fontsize=footnotesize spacing=1.1
>
...
| Trypsin/EDTA in PBS | 0.05% Trypsin/ 0.02% EDTA in PBS; (PAN Biotech Cat. No. P10-023500) | Cell dissociation |
| 1x PBS | 2.7 mM KCl, 1.5 mM KH~2~PO~4~, 8.0 mM Na~2~HPO~4~, 137 mM NaCl in dH~2~O. | Removal of dead cells |
| 2x SEAP buffer | 20 mM homoarginine, 1 mM MgCl~2~, 21% (v/v) diethanolamine, pH 9.8 | Inhibition of endogenous phosphatases |
| pNPP | 120 mM in dH~2~O | SEAP substrate |
...
> [!figure] #fig:seap-formula width=80% align=left pos=H
> ![](/img/user/figures/seap_formula.png)
> Pipetting scheme.
...
In this experiment, we adapt the naturally occurring protein _cis_- and *trans*-splicing catalyzed by the DnaE intein from _Nostoc punctiforme_ (*Npu*DnaE intein) to engineer a synthetic protein logic gate. As previously explained in section 1.1.2, inteins are protein domains with autocatalytic activity that give rise to a reconstituted functional protein after self-excising from the host or precursor protein. Protein splicing can occur either in _cis_ (excision of an intein) or in _trans_, leading to the ligation of two individual proteins, each fused to one fragment of a split intein. In Experiment I, we have cloned the bacterial inducible plasmids that we need for this experiment (**@Fig:cloning-strategy**):
...
We will transform and induce protein production in the *Escherichia coli* strain T7-Express using competent cells following the scheme in **@Fig:cloning-strategy**:
...
> [!figure] #fig:logic-gate width=100% align=left pos=H
> <iframe src="/img/user/figures/inteins_boolean_gates.pdf" width="100%" height="900px" title="inteins_boolean_gates" style="border:1px solid #ccc;"></iframe>
>
> ** Scheme for the protein *trans*-splicing experiment to design logic gates.

### Materials

> [!table] #tbl:materials-exp3 width=100% align=left
> 
...
> [!table] #tbl:experimental-setup width=100% align=left
...
6. Measure OD<sub>600</sub> nm until ~0.6 (better lower than higher!), follow the bacterial growth by noting the OD values on the white board together with the time of measurement. Analyze the growth curve.
...
> [!figure] #fig:domain-swapping width=100% align=left pos=H
> <iframe src="/img/user/figures/inteins_plasms_membrane.pdf" width="100%" height="900px" title="inteins_plasms_membrane" style="border:1px solid #ccc;"></iframe>
>
> ** Split intein-catalyzed protein trans-splicing (PTS) reaction either leading to the addition (left), or exchange (right) of GFP and mCherry at the plasma membrane, depending on the domain order of the GFP constructs (pDD130 vs pDD132). The IntC-fused mCherry construct pDD131 is identical in both approaches.
...
> [!table] #tbl:materials-exp-III width=100% align=left colsep=4pt fontsize=footnotesize spacing=1.1
>
> Materials used in Experiment III.
...
> [!table] #tbl:exp3dna width=100% align=left colsep=4pt fontsize=footnotesize spacing=1.1
>
...
> [!table] #tbl:exp3media width=100% align=left colsep=4pt fontsize=footnotesize spacing=1.1
>
> Media
...
> [!table] #tbl:ex3cells width=100% align=left colsep=4pt fontsize=footnotesize spacing=1.1
>
> Cells
...
|*E. coli* TOP10|Chemically-competent cells. Genotyp: F-*mcrA* Δ(*mrr-hsd_RMS-*mcr_BC) Φ80*Lac*ZΔM15 Δ*Lac*X74 *rec*A1 *ara*D139 Δ(*araleu*) 7697 *gal*U *gal*K *rps*L (StrR) *end*A1 *nup*G.|


> [!table] #tbl:exp3buffers width=100% align=left colsep=4pt fontsize=footnotesize spacing=1.1
>
...
> [!table] #tbl:exp3cons width=100% align=left colsep=4pt fontsize=footnotesize spacing=1.1
>
> Consumables
...
1. Per well, dilute 0.75 µg of DNA in OptiMEM to a final volume of 50 µL (remember your Midi-prep concentration). Please check **@Tbl:transfection-odd** and **@Tbl:transfection-even** for further information.
...
3. Per well, dilute 2.5 µL of PEI solution in OptiMEM to a final volume of 50 µL. Vortex. Please check **@Tbl:transfection-odd** and **@Tbl:transfection-even** for further information.
...
> [!table] #tbl:transfection-odd width=100% align=left
> 
...
> [!table] #tbl:transfection-even width=100% align=left
> 
...
> [!figure] #fig:tet-system width=60% align=left pos=H
> ![](/img/user/figures/Tet-On.png)
>
> ** Schematic representation of the Tet-On system.** The Tet-On 3G protein is constitutively expressed under the control of the CAG promoter. Upon addition of tetracycline, the Tet-On 3G protein undergoes a conformational change that enables it to bind to the TRE3G promoter, thereby activating transcription and inducing neonGreen expression.
...
> [!table] #tbl:materials-exp5 width=\textwidth align=left
...
> [!table] #tbl:exp5plasmids width=100% align=left colsep=4pt fontsize=footnotesize spacing=1.1
>
...
> [!table] #tbl:yourtablelabel width=100% align=left colsep=4pt fontsize=footnotesize spacing=1.1
>
> **Here we still need to add a table as pdf figure**
